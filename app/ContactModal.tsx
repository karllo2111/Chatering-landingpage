...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
    ...
    return (
        ...
        >
            ...
            {/* Modal content */}
            <div
                className="relative bg-surface-container-lowest rounded-t-3xl sm:rounded-3xl p-8 w-full sm:max-w-md shadow-2xl modal-content"
                onClick={(e) => e.stopPropagation()}
            >
                {/* Close button */}
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center hover:bg-surface-dim transition-colors"
                >
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        >
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#bc1888] flex items-center justify-center shrink-0">
                                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Email */}
                        <a
                            href="mailto:langsengibu@gmail.com"
                        ...
                        >
                            ...
                            <div>
                                <span className="font-bold text-primary group-hover:underline">Email</span>
                                <p className="text-xs text-on-surface-variant">Kirim email ke kami</p>
                            </div>
                            <span className="material-symbols-outlined ml-auto text-on-surface-variant group-hover:translate-x-1 transition-transform">
                                arrow_forward
                            </span>
